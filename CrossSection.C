...
void CrossSection(double Enu = 10.){
  ...
  TH1F *histE = new TH1F("histE","",1000,0.,Enu);
  TH1F *histEanu = new TH1F("histEanu","",1000,0.,Enu); 

  TH1F *histEMC = new TH1F("histEMC","",1000,0.,Enu);
  TH1F *histEMCanu = new TH1F("histEMCanu","",1000,0.,Enu);
